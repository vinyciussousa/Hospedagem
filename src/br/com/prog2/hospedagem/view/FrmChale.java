		...
		gl_contentPane.setVerticalGroup(
			gl_contentPane.createParallelGroup(Alignment.TRAILING)
				.addGroup(Alignment.LEADING, gl_contentPane.createSequentialGroup()
					...
					.addPreferredGap(ComponentPlacement.RELATED)
					.addComponent(panel_2, GroupLayout.PREFERRED_SIZE, 218, Short.MAX_VALUE)
					.addContainerGap())
		);
				...
				.addGroup(gl_panel.createSequentialGroup()
					.addGroup(gl_panel.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_panel.createSequentialGroup()
							...
							.addPreferredGap(ComponentPlacement.RELATED)
							.addComponent(txtCodChale, GroupLayout.DEFAULT_SIZE, 407, Short.MAX_VALUE))
						.addGroup(gl_panel.createSequentialGroup()
							.addComponent(lblLocalizao)
							.addPreferredGap(ComponentPlacement.RELATED)
							.addComponent(txtLocalizacao, GroupLayout.DEFAULT_SIZE, 386, Short.MAX_VALUE))
						.addGroup(gl_panel.createSequentialGroup()
							.addComponent(lblCapacidade)
							.addPreferredGap(ComponentPlacement.RELATED)
							.addComponent(txtCapacidade, GroupLayout.DEFAULT_SIZE, 384, Short.MAX_VALUE))
						.addGroup(gl_panel.createSequentialGroup()
							.addComponent(lblValorAltaEstao)
							.addPreferredGap(ComponentPlacement.RELATED)
							.addComponent(txtValorAltaEstacao, GroupLayout.DEFAULT_SIZE, 353, Short.MAX_VALUE))
						.addGroup(gl_panel.createSequentialGroup()
							.addComponent(lblValorBaixaEstao)
							.addPreferredGap(ComponentPlacement.RELATED)
							.addComponent(txtValorBaixaEstacao, GroupLayout.DEFAULT_SIZE, 346, Short.MAX_VALUE))
